// irisos - Browser Module
// Shows a basic web browser like Internet Explorer
...
const websites = {
  'about:home': {
    title: 'irisos Browser Home',
    content: `
    Welcome to irisos Browser!
  ...
  'about:settings': {
    ...
    Homepage: about:home
    Search Engine: irisos Search
    Clear Browsing Data: [Clear Now]
    Version: irisos Browser 1.0
    `
  },
  'irisos.help': {
    title: 'irisos Help Portal',
    content: `
    irisos Help Portal
    ------------------
    
    Welcome to the irisos Help Portal. Here you can find information about
    using your irisos system.
  ...
  'irisos.web': {
    title: 'irisos Web Portal',
    content: `
    irisos Web Portal
    ----------------
    
    Welcome to the irisos Web Portal!
    
    This is your gateway to the virtual internet within irisos.
    
    Available sites:
    - mail.irisos.local (irisos Mail)
    - chat.irisos.local (irisos Chat)
    - docs.irisos.local (irisos Documents)
    - games.irisos.local (irisos Games)
    
    News:
    - irisos Browser updated to version 1.0
    - New applications available in the App Store
    - System update available: irisos 1.1
    `
  },
  'mail.irisos.local': {
    title: 'irisos Mail',
    ...
    > Welcome to irisos [System Admin]
    > Your account has been created [System Admin]
    > Getting started with irisos [Help Team]
...
function renderBrowser() {
  ...
  console.log(colorText('║ irisos Browser                                      [_] [□] [X]║', 'blue'));
  console.log(colorText('╠════════════════════════════════════════════════════════════════╣', 'blue'));
...
function navigateTo(url) {
  ...
  // Check if the page exists in our  web
...
function showBrowserHelp() {
  ...
  console.log('  irisos.help    - irisos Help Portal');
  console.log('  irisos.web     - irisos Web Portal');
  console.log('  mail.irisos.local - irisos Mail');
  console.log('  chat.irisos.local - irisos Chat');
  console.log('  docs.irisos.local - irisos Documents');
  console.log('  games.irisos.local - irisos Games');
  console.log('');
}
