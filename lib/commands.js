...
const commandHelp = {
  ...
  exit: {
    description: 'Exit the TextOS shell',
    usage: 'exit',
    examples: [
      'exit',
      'shutdown'
...
function handleSysinfo(args, context) {
  console.log(colorText('\nTextOS System Information\n', 'cyan'));
  console.log(`${colorText('System:', 'green')} TextOS v1.0`);
