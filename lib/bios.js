...
const defaultConfig = {
  ...
  hostname: 'irisos',
  desktopTheme: 'dark',
  systemMemory: 512, // Simulated MB
  hardDriveSize: 2048, // Simulated MB
...
function setupBIOS() {
  return new Promise((resolve) => {
    ...
    function configureSystem() {
      ...
      console.log(`5. System Memory: ${config.systemMemory} MB (simulated)`);
      console.log(`6. Hard Drive Size: ${config.hardDriveSize} MB (simulated)`);
